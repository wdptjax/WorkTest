...
namespace Common
{
    ...
    internal class IniFiles
    {
        ...
        public string ReadString(string Section, string Ident, string Default)
        {
            ...
            int bufLen = GetPrivateProfileStringA(Section, Ident, Default, Buffer, Buffer.GetUpperBound(0), FileName);
        ...
        public void ReadSection(string Section, StringCollection Idents)
        {
            ...
            int bufLen = GetPrivateProfileStringA(Section, null, null, Buffer, Buffer.GetUpperBound(0), FileName);
            //对Section进行解析
        ...
        public void ReadSections(StringCollection SectionList)
        {
            ...
            byte[] Buffer = new byte[65535];
            int bufLen = 0;
            bufLen = GetPrivateProfileStringA(null, null, null, Buffer,
